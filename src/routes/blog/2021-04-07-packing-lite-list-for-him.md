...
<ImageWithCaption url="/images/tylerbackpack-small-1.jpeg" alt="Topo dayback, might be a few generations old at this point" />

<ImageWithCaption url="/images/tylerflash-small.jpeg" alt="Small flash backpack that we use for hikes or situations where things need to stay dry, like kayaking" />
...
<ImageWithCaption url="/images/tylerrainjacket-small.jpeg" alt="Columbia Rain Jacket" />
...
<ImageWithCaption url="/images/tylerbuttonup-small.jpg" alt="Tyler's Buttonup shirt" />
...
<ImageWithCaption url="/images/tylerpants-small.jpeg" alt="Columbia Pants" />
...
<ImageWithCaption url="/images/tylershorts-small.jpg" alt="My shorts! a pair of puma running shorts and an REI pair of hiking shorts." />
...
<ImageWithCaption url="/images/tylershirts-small.jpg" alt="My shirts and underwear" />

I have a **long sleeve ExOffico** shirt that is great for when I need just a bit more warmth or sun protection.

<ImageWithCaption url="/images/tylerlongsleeve-small.jpg" alt="Shirts" />
...
- **Earth runner sandals** - These are my main footwear if the weather will allow it.
  ...
  <ImageWithCaption url="/images/tylershoes-small.jpg" alt="My footwear" />
...
- Headlamp - we are hiking a bit in caves and is useful for night time reading and stuff.
  ...
  <ImageWithCaption url="/images/tylersmallbits-small.jpg" alt="Some of my small things I take on a trip" />

- Roll up water bottle.

  <ImageWithCaption url="/images/2017-08-18-17.46.16.jpg" alt="Packs small, yet still hold shape" />
...
- **Fold up REI hat**
  ...
  <ImageWithCaption url="/images/Tylerfolduphat-small.jpg" alt="Fold up hat helps with sweat and sun" />
